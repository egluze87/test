...
public class RegisterActivity extends Activity {
    ...
    private static final String REGISTER_URL = "http://egle.byethost5.com/mobile/register.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.register = (Button) findViewById(R.id.register_register_button_id);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(repeat_password.getText().toString())) {
                    repeat_password.setError("Neįvestas pakartotinis slaptažodis");
                ...
                {
                    repeat_password.setError("Slaptažodžiai turi sutapti");
                    focusView = repeat_password;
                    cancel = true;
                }
                if (!validateEmail(email.getText().toString())) {
                    email.setError("Neteisingai įvestas el. paštas");
                    focusView = email;
                    cancel = true;
                }
                if (cancel) {
                    ...
                    VartotojoRegistracija naujaReg = new VartotojoRegistracija(username.getText().toString(), email.getText().toString(), password.getText().toString());
                    registerUser(naujaReg.getRegiVardas(), naujaReg.getRegiSlaptazodis(), naujaReg.getRegiEmail());
