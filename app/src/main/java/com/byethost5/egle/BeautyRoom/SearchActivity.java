    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://egle.byethost5.com/mobile/searchconfirm.php");
            ...
            try {
                ...
                Uri.Builder builder = new Uri.Builder().appendQueryParameter("searchQuery", searchQuery).appendQueryParameter("username", "Administratorius");
                ...
                try {
                    ...
                    for (int i = 0; i < jArray.length(); i++) {
                        ...
                        Registracija registracija = new Registracija(
                                ...
                                json_data.getString("procedura"),
                                json_data.getString("data"),
                                json_data.getString("laikas"),
                                json_data.getString("darbuotojas")
                        );
                        data.add(registracija);
                    }

                    // Setup and Handover data to recyclerview
                    mRVFish = (RecyclerView) findViewById(R.id.proceduraList);
